...
test("kyc trust test", async({page})=>{
    ...
    //await auth.clickonSave();
    await page.locator("(//span[text()='Trust information'])[2]").click();

    await bank.enterOfficeName("trust");
    ...
    //await auth.clickonSave();
    await page.locator("(//span[text()='Trust Address'])[2]").click();

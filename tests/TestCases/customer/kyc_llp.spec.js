...
test("kyc llp test", async({page})=>{
    ...
    await kycbento.clickOn_kyc_llp();
    ...
    //await auth.clickonSave();
    await page.locator("(//span[text()=' LLP Info. & Bank details'])[2]").click();

    await bank.enterOfficeName("LLP");
    ...
    //await auth.clickonSave();
    await page.locator("(//span[text()='LLP Address'])[2]").click();
